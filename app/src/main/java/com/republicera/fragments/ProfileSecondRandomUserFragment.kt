...
class ProfileSecondRandomUserFragment : Fragment(), ProfileMethods {
    ...
    private lateinit var sharedViewModelForSecondRandomUser: RandomUserSecondViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity.let {
            sharedViewModelForSecondRandomUser =
                ViewModelProviders.of(it).get(RandomUserSecondViewModel::class.java)
        ...
        contactDetailsIconsRecycler.layoutManager = GridLayoutManager(this.context, 6)
        ...
        sharedViewModelForSecondRandomUser.randomUserObject.observe(this, Observer {
            it?.let { user ->
                userProfile = user
    ...
    companion object {
        fun newInstance(): ProfileSecondRandomUserFragment = ProfileSecondRandomUserFragment()
    }
}